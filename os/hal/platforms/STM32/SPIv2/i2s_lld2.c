...
void i2s_lld_start(I2SDriver *i2sp) {
   chDbgAssert(TRUE, "i2s_lld_start(), NOURRR", "stream already allocated");
  ...
  if (i2sp->state == I2S_STOP) {
    ...
    if (&I2SD1 == i2sp) {
      ...
      b = dmaStreamAllocate(i2sp->dmarx,
                            ...
                            (void *)i2sp);
       chDbgAssert(!b, "i2s_lld_start(), #1", "stream already allocated");
      ...
      b = dmaStreamAllocate(i2sp->dmatx,
                            ...
                            (void *)i2sp);
       chDbgAssert(!b, "i2s_lld_start(), #2", "stream already allocated");
    ...
    if (&I2SD2 == i2sp) {
      ...
      b = dmaStreamAllocate(i2sp->dmarx,
                            ...
                            (stm32_dmaisr_t)i2s_lld_serve_rx_interrupt,
                            (void *)i2sp);
      chDbgAssert(!b, "i2s_lld_start(), #3", "stream already allocated");
      ...
      b = dmaStreamAllocate(i2sp->dmatx,
                            ...
                            (stm32_dmaisr_t)i2s_lld_serve_tx_interrupt,
                            (void *)i2sp);
      chDbgAssert(!b, "i2s_lld_start(), #4", "stream already allocated");
    ...
    if (&I2SD3 == i2sp) {
      ...
      b = dmaStreamAllocate(i2sp->dmarx,
                            ...
                            (stm32_dmaisr_t)i2s_lld_serve_rx_interrupt,
                            (void *)i2sp);
       chDbgAssert(!b, "i2s_lld_start(), #5", "stream already allocated");
      ...
      b = dmaStreamAllocate(i2sp->dmatx,
                            ...
                            (stm32_dmaisr_t)i2s_lld_serve_tx_interrupt,
                            (void *)i2sp);
       chDbgAssert(!b, "i2s_lld_start(), #6", "stream already allocated");
