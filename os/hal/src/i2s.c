...
void i2sStart(I2SDriver *i2sp, const I2SConfig *config) {
  ...
  chDbgCheck((i2sp != NULL) && (config != NULL), "spiStart");
...
void i2sStartExchange(I2SDriver *i2sp) {
  ...
  chDbgCheck(i2sp != NULL, "spiSelect");

  chSysLock();
  chDbgAssert(i2sp->state == I2S_READY, "spiSelect(), #1", "not ready");
...
void i2sStopExchange(I2SDriver *i2sp) {
  ...
  chDbgCheck(i2sp != NULL, "spiUnselect");

  chSysLock();
  chDbgAssert((i2sp->state == I2S_READY) ||
                (i2sp->state == I2S_ACTIVE) ||
                (i2sp->state == I2S_COMPLETE),"spiUnselect(), #1", "not ready");
